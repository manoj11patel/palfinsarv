        ...
        <div class="row">
            ...
            <div class="col-md-3 col-lg-2 sidebar">
                <div class="sidebar-header">
                    ...
                    <small class="badge bg-light text-dark mt-2">Customer</small>
                </div>
                <nav class="nav flex-column">
                    <a href="{{ route('customer.dashboard') }}" class="nav-link @if(Route::is('customer.dashboard')) active @endif">
                        <i class="bi bi-graph-up"></i> Dashboard
                    </a>
                    <a href="{{ route('customer.videos.index') }}" class="nav-link @if(Route::is('customer.videos*')) active @endif">
